...
class CharacterAdapter(private val characters: MutableList<Yugioh>) : RecyclerView.Adapter<CharacterAdapter.CharacterViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CharacterViewHolder, position: Int) {
        ...
        //holder.characterAge.text = character.name
    }
}